    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">VISION</span> <span class="clr-green">Cafeteria</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md"><br><span class="clr-red md">VISION</span> <span class="clr-green md">Cafeteria</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Engineering and professional education are 
                        among the key enablers of growth for transforming 
                        the national as well as the global economy. As we 
                        continue to strive for academic excellence in 
                        engineering and management education, through 
                        innovative techniques, ABES Engineering College is being
                        preferred as the destination for students across the country.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/collegeofengabes/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/abesec_official/?hl=en" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://github.com/Ayuska-Singh/VISION_CAFETERIA" target="_blank">Git Repository</a></li>
                            <li><a href="https://abes.ac.in/" target="_blank">ABESEC</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>0120 713 5112</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>https://abes.ac.in/courses-offered.php</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>19th KM Stone, NH-09, Ghaziabad, Uttar Pradesh 201009</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: https://abes.ac.in/CAREER-department.php</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">AYUSKA and ANUKRATI</a></div>
                </main>
            </section>
        `;
        })
